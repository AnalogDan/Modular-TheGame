TuringState = Class{__includes = BaseState}

function TuringState:init(tales)
    self.tales = tales
    self.direction = "left"
end

function TuringState:enter()
end
...
function TuringState:update(dt)
