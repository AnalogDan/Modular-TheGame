PitagorasState = Class{__includes = BaseState}

function PitagorasState:init(tales)
    self.tales = tales
    self.direction = "left"
end

function PitagorasState:enter()
end
...
function PitagorasState:update(dt)
...
function PitagorasState:render()
