JuarismiState = Class{__includes = BaseState}

function JuarismiState:init(tales)
    self.tales = tales
    self.direction = "left"
end

function JuarismiState:enter()
end
...
function JuarismiState:update(dt)
