 ArquimedesState = Class{__includes = BaseState}

function ArquimedesState:init(tales)
    self.tales = tales
    self.direction = "left"
end

function ArquimedesState:enter()
end
...
function ArquimedesState:update(dt)
...
function ArquimedesState:render()
