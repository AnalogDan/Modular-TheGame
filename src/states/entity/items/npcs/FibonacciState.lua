FibonacciState = Class{__includes = BaseState}

function FibonacciState:init(tales)
    self.tales = tales
    self.direction = "left"
end

function FibonacciState:enter()
end
...
function FibonacciState:update(dt)
...
function FibonacciState:render()
